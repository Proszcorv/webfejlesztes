...
function bg_1() {
    document.getElementById("bg").style.backgroundImage = "url('media/noxus.jpg')"
}

function bg_2() {
    document.getElementById("bg").style.backgroundImage = "url('media/shadow_isles.jpg')"
}

function bg_3() {
    document.getElementById("bg").style.backgroundImage = "url('media/demacia.jpg')"
}
