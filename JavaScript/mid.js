...
function bg_1() {
    document.getElementById("bg").style.backgroundImage = "url('media/zaun.jpg')"
}

function bg_2() {
    document.getElementById("bg").style.backgroundImage = "url('media/ionia.jpg')"
}

function bg_3() {
    document.getElementById("bg").style.backgroundImage = "url('media/void.jpg')"
}
